...
void
operator delete(void* p, std::nothrow_t) noexcept
{
    operator delete(p); // Same as regular delete
}

void
operator delete(void* p, const size_t req_size) noexcept
{
    _ker_free(req_size, p);
}

void
operator delete(void* p, const size_t req_size, std::nothrow_t) noexcept
{
